...
public class stairCase {
	...
	public static  stairHelper[] countOptions(int totalSteps, int [] stepSizes) {
	...
	public static void printStair(stairHelper stair, String message) {
	...
	public static int getTotalStairs() {
		int numSteps = 0;
	...
	public static int[] getStepSizes() {
		String desiredSizes = JOptionPane.showInputDialog("Enter the step sizes seperated by a ',' and spaces. For example: 1, 2, 3");
